<%-- 
    Document   : AddUser
    Created on : Apr 1, 2017, 9:00:37 AM
     ...
     <body>
        <div class="w3-container">
           <%
                ...
                if(login_msg!=null)
                out.println("<h3><font color=green size=4px>"+login_msg+"</font></h3>");
        %>
            ...
            <div class="row" align="center">
                ...
                <div class="col-sm-12">
                    <button class="button hvr-grow" name="but" type="submit" value="login" style="width: 100%"><b>Add User</b></button>
                </div>
            </div>
            </form>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                    <button class="button hvr-grow" type="submit" style="width:200px;"  name="button"><b>Go Back</b></button>
            </div>
        </div>
        </form>
    </body>
